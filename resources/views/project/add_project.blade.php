            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <form action="{{ route('project.store') }}" method="post">
                    ...
                    <div>
                        ...
                        <div class="my-3">
                                   <textarea cols="30" rows="4" type="text" name="description" value="{{ old('description') }}"
                                   placeholder="Enter Description Text"
                                   id="description"
                                   class="border-gray-300 shadow-sm w-full rounded-lg text-black"></textarea>
                            @error('description')
                                <span class="text-red-300 font-medium">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <div class="my-3">
                            <input type="text" name="live_link_url" value="{{ old('github_url') }}"
